export default {
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of mAI. mAI is not responsible for any consequences arising from this shared content.',
  ...
  'taskList.unassignedHint': 'May will run this task when no assignee is set',
