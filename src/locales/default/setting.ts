export default {
  'gamification.badges.searchPlaceholder': 'Search for a badge...',
  'gamification.badges.detailsTitle': 'Badge Details',
  'gamification.badges.unpin': 'Unpin from profile',
  'gamification.badges.pin': 'Pin to profile',
  'gamification.badges.condition': 'Requirement:',
  'gamification.badges.progress': 'Progress',
  'gamification.quests.dailyTitle': 'Daily Quests',
  'gamification.quests.dailyDesc': 'Reset at midnight CET',
  'gamification.quests.weeklyTitle': 'Weekly Quests',
  'gamification.quests.weeklyDesc': 'Reset Monday at midnight CET',
  'gamification.quests.claim': 'Claim',
  'gamification.quests.bonus': 'Get 3 extra quests (1/week)',
  'tab.rewardsLevels': 'Niveaux',
  ...
  'tab.pets': 'Pets',
  'settingPets.enable.title': 'Enable Pets',
  'settingPets.enable.desc': 'Enable or disable the display of virtual companions.',
  'settingPets.list.title': 'Virtual Companions',
  'settingPets.list.desc': 'Pets accompany you in mAI! Choose one that suits you!',
  'settingPets.list.empty': 'No pet selected. Open the store to add one.',
  'settingPets.list.openStore': 'Open Pets Store',
  'settingPets.zoom.title': 'Size (Zoom)',
  'settingPets.zoom.desc': 'Adjust the display size of your pets.',
  ...
  'settingPets.section.choice': 'Companion Selection',
  'settingPets.section.options': 'Options',
