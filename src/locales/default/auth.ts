export default {
  ...
  'betterAuth.signin.continueWithDiscord': 'Continue with Discord',
  'betterAuth.signin.continueWithSlack': 'Continue with Slack',
  'betterAuth.signin.continueWithSpotify': 'Continue with Spotify',
  'betterAuth.signin.continueWithTelegram': 'Continue with Telegram',
  'betterAuth.signin.continueWithTwitch': 'Continue with Twitch',
  'betterAuth.signin.continueWithNotion': 'Continue with Notion',
  'betterAuth.signin.continueWithCanva': 'Continue with Canva',
  'betterAuth.signin.continueWithX': 'Continue with X',
  ...
  'signin.title': 'Avec mAI, passez à la vitesse supérieure',
  'signout': 'Log Out',
  'signup': 'Sign Up',
