export default {
  ...
  'cmdk.noResult': 'No results found',
  'notification.actions.copy': 'Copy',
  'notification.actions.delete': 'Delete',
  'notification.actions.markAsRead': 'Mark as read',
  'notification.actions.markAsUnread': 'Mark as unread',
  'notification.actions.pin': 'Pin',
  'notification.actions.pinLimitReached': 'Pin limit reached',
  'notification.actions.sendToIA': 'Send to AI',
  'notification.actions.soon': 'Coming soon',
  'notification.actions.unpin': 'Unpin',
  'notification.deleteAll': 'Delete all',
  'notification.deleteAllConfirm': 'Are you sure you want to delete everything?',
  'notification.empty': 'No notifications',
  'notification.filters.all': 'All',
  'notification.filters.error': 'Errors',
  'notification.filters.pinned': 'Pinned',
  'notification.filters.success': 'Success',
  ...
  'feedback.fields.email.invalid': 'Please enter a valid email',
  'feedback.fields.email.label': 'Email',
  'feedback.fields.email.maxLength': 'Email must be 200 characters or less',
  'feedback.fields.email.placeholder': 'mail@mai.com',
