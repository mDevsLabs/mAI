...
export const OFFICIAL_URL = 'https://mprojects-officiel.vercel.app';
export const OFFICIAL_SITE = 'https://mprojects-officiel.vercel.app';
export const OFFICIAL_DOMAIN = 'mprojects-officiel.vercel.app';
