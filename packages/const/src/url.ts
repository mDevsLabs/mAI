...
export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/mDevsLabs/mAI/discussions';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/mDevsLabs/mAI/discussions';

export const AGENTS_INDEX_GITHUB = 'https://github.com/mDevsLabs/mAI';
export const AGENTS_INDEX_GITHUB_ISSUE = urlJoin(AGENTS_INDEX_GITHUB, 'issues/new');
export const AGENTS_OFFICIAL_URL = 'https://mprojects.odoo.com/m-ai';
...
export const BASE_PROVIDER_DOC_URL = 'https://mprojects.odoo.com/docs/usage/providers';
export const SITEMAP_BASE_URL = isDev ? '/sitemap.xml/' : 'sitemap';
export const CHANGELOG_URL = urlJoin(OFFICIAL_SITE, 'm-ai');

export const DOWNLOAD_URL = {
  android: 'https://play.google.com/store/apps/details?id=com.mdevslabs.mai',
