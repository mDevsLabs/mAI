export default {
  ...
  'messengerBanner.title': 'Talk to May on your favorite messaging apps',
  ...
  'generation.hero.taglinePrefix_0': 'Start creating an',
  'generation.hero.taglinePrefix_1': 'Bring to life an',
  'generation.hero.taglinePrefix_2': 'Imagine and design an',
  'generation.hero.taglinePrefix_3': 'Be inspired by an',
  'generation.hero.taglinePrefix_4': 'Instantly generate an',
  'generation.hero.taglinePrefix_5': 'Create magic with an',
  'generation.hero.taglinePrefix_6': 'Visualize your ideas with an',
  'generation.hero.taglinePrefix_7': 'Explore new horizons with an',
  'generation.hero.taglinePrefix_8': 'Express your creativity via an',
  'generation.hero.taglinePrefix_9': 'Tell a story with an',
  'generation.hero.taglinePrefix_10': 'Shape your vision with an',
  'generation.hero.taglinePrefix_11': 'Enhance your project with an',
  'generation.hero.taglinePrefix_12': 'Achieve the impossible with an',
  'generation.hero.taglinePrefix_13': 'Dive into the art of generating an',
  'generation.hero.taglinePrefix_14': 'Make a splash with an',
  'generation.hero.taglinePrefix_15': 'Turn your words into an',
  'generation.hero.taglinePrefix_16': 'Create the unexpected with an',
  'generation.hero.taglinePrefix_17': 'Awaken your imagination with an',
  'generation.hero.taglinePrefix_18': 'Shape reality with an',
  'generation.hero.taglinePrefix_19': 'Invent a new world with an',
