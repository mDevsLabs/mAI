export default {
  ...
  'gateway.statusConnected': 'Device Connection is on',
  'gateway.statusConnecting': 'Turning on Device Connection...',
  'gateway.statusDisconnected': 'Device Connection is off',
  'gateway.title': 'Device Connection',
