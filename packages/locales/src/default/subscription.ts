export default {
  ...
  'keyMissMatch.description':
    'Due to an occasional system failure, your current subscription usage is temporarily inactive. Please click the button below to restore usage and continue the conversation. If this happens repeatedly, please contact us via email (support@mprojects.odoo.com)',
  ...
  'qa.workspace.list.plans.a':
    '{{free}} is free and includes a single seat, ideal for solo use to try out the workspace experience. {{pro}} provides a monthly credit allowance and unlocks team seats, seat management, priority support, and other advanced features.',
