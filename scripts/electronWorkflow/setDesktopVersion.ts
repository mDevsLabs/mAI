...
function updatePackageJson() {
  ...
  try {
    ...
    switch (releaseType) {
      ...
      case 'beta': {
        packageJson.productName = 'mAI-Beta'; // Or 'LobeHub-Beta' if preferred
        packageJson.name = 'mai-desktop-beta'; // Or 'lobehub-desktop' if preferred
        console.log('🧪 Setting as Beta version.');
        updateAppIcon('beta');
        break;
      }
      case 'nightly': {
        packageJson.productName = 'mAI-Nightly'; // Or 'LobeHub-Nightly'
        packageJson.name = 'mai-desktop-nightly'; // Or 'lobehub-desktop-nightly'
