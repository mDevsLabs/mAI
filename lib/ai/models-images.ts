...
export const aiHordeImageModels: ImageModel[] = [
  { id: "2DN", name: "2DN", provider: "ai-horde", performance: 325822.9 },
  { id: "526Mix-Animated", name: "526Mix Animated", provider: "ai-horde" },
  { id: "AAM XL", name: "AAM XL", provider: "ai-horde", performance: 300491.8 },
  { id: "AbsoluteReality", name: "Absolute Reality", provider: "ai-horde", performance: 523543.3 },
  { id: "Abyss OrangeMix", name: "Abyss OrangeMix", provider: "ai-horde" },
  { id: "AbyssOrangeMix-AfterDark", name: "Abyss OrangeMix AfterDark", provider: "ai-horde", performance: 186414.2 },
  { id: "ACertainThing", name: "A Certain Thing", provider: "ai-horde" },
  { id: "AIO Pixel Art", name: "AIO Pixel Art", provider: "ai-horde" },
  { id: "AlbedoBase XL 3.1", name: "AlbedoBase XL 3.1", provider: "ai-horde", performance: 452522.5 },
  { id: "AlbedoBase XL (SDXL)", name: "AlbedoBase XL (SDXL)", provider: "ai-horde", performance: 533291.7 },
  { id: "AMPonyXL", name: "AM Pony XL", provider: "ai-horde", performance: 875207.2 },
  ...
  { id: "Anything v3", name: "Anything v3", provider: "ai-horde", performance: 765453.1 },
  ...
  { id: "BB95 Furry Mix v14", name: "BB95 Furry Mix v14", provider: "ai-horde", performance: 606978.6 },
  { id: "BigASP", name: "BigASP", provider: "ai-horde" },
  { id: "Blank Canvas XL", name: "Blank Canvas XL", provider: "ai-horde", performance: 87006.2 },
  ...
  { id: "Counterfeit", name: "Counterfeit", provider: "ai-horde", performance: 613896.5 },
  { id: "CyberRealistic Pony", name: "CyberRealistic Pony", provider: "ai-horde", performance: 5619261.3 },
  ...
  { id: "Deliberate", name: "Deliberate", provider: "ai-horde", performance: 628586.7 },
  ...
  { id: "Dreamshaper", name: "Dreamshaper", provider: "ai-horde", performance: 544339.1 },
  ...
  { id: "Edge Of Realism", name: "Edge Of Realism", provider: "ai-horde", performance: 554527.8 },
  ...
  { id: "Flux.1-Schnell fp8 (Compact)", name: "Flux.1 Schnell FP8", provider: "ai-horde", performance: 99833.4 },
  { id: "Furry Epoch", name: "Furry Epoch", provider: "ai-horde", performance: 984337 },
  ...
  { id: "Grapefruit Hentai", name: "Grapefruit Hentai", provider: "ai-horde", performance: 1159942.8 },
  { id: "GTA5 Artwork Diffusion", name: "GTA5 Artwork Diffusion", provider: "ai-horde" },
  { id: "HASDX", name: "HASDX", provider: "ai-horde" },
  { id: "Hassaku XL", name: "Hassaku XL", provider: "ai-horde", performance: 474191.3 },
  { id: "Healy's Anime Blend", name: "Healy's Anime Blend", provider: "ai-horde" },
  { id: "Hentai Diffusion", name: "Hentai Diffusion", provider: "ai-horde", performance: 179401.9 },
  { id: "HolyMix ILXL", name: "HolyMix ILXL", provider: "ai-horde" },
  { id: "HRL", name: "HRL", provider: "ai-horde" },
  { id: "ICBINP - I Can't Believe It's Not Photography", name: "ICBINP", provider: "ai-horde", performance: 574787.2 },
  ...
  { id: "Juggernaut XL", name: "Juggernaut XL", provider: "ai-horde", performance: 703639.3 },
  { id: "KaynegIllustriousXL", name: "Kayneg Illustrious XL", provider: "ai-horde", performance: 321119 },
  ...
  { id: "Movie Diffusion", name: "Movie Diffusion", provider: "ai-horde", performance: 955433.5 },
  ...
  { id: "Nova Anime XL", name: "Nova Anime XL", provider: "ai-horde", performance: 688364.5 },
  { id: "Nova Furry Pony", name: "Nova Furry Pony", provider: "ai-horde" },
  { id: "NTR MIX IL-Noob XL", name: "NTR MIX IL-Noob XL", provider: "ai-horde", performance: 383355.9 },
  ...
  { id: "Quiet Goodnight XL", name: "Quiet Goodnight XL", provider: "ai-horde", performance: 340067.3 },
  ...
  { id: "stable_diffusion", name: "Stable Diffusion", provider: "ai-horde", performance: 401456.1 },
  ...
  { id: "WAI-ANI-NSFW-PONYXL", name: "WAI-ANI NSFW Pony XL", provider: "ai-horde", performance: 616087.5 },
  { id: "WAI-CUTE Pony", name: "WAI-CUTE Pony", provider: "ai-horde" },
  { id: "waifu_diffusion", name: "Waifu Diffusion", provider: "ai-horde", performance: 167649.2 },
  { id: "WAI-NSFW-illustrious-SDXL", name: "WAI-NSFW Illustrious SDXL", provider: "ai-horde", performance: 1093021.8 },
  { id: "Western Animation Diffusion", name: "Western Animation Diffusion", provider: "ai-horde" },
  { id: "White Pony Diffusion 4", name: "White Pony Diffusion 4", provider: "ai-horde", performance: 513231.9 },
  ...
  { id: "Zeipher Female Model", name: "Zeipher Female Model", provider: "ai-horde", performance: 424019.6 },
  { id: "Z-Image-Turbo", name: "Z-Image Turbo", provider: "ai-horde", performance: 620806.7 },
];
