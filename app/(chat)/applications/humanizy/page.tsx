      ...
      <div className="mx-auto w-full max-w-4xl px-4 py-8 md:px-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 mb-8">
          ...
          <div className="rounded-2xl border border-border/40 bg-card p-4 shadow-[var(--shadow-card)]">
            <label htmlFor="text-to-analyze" className="text-xs font-semibold text-muted-foreground/60 mb-2 block">TEXTE À ANALYSER</label>
            <textarea
              id="text-to-analyze"
          ...
          <button 
            type="button"
            className="rounded-2xl border-2 border-dashed border-border/40 bg-card/50 p-6 flex flex-col items-center justify-center cursor-pointer hover:border-emerald-500/50 transition-colors w-full"
