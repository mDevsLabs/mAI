---
title: "mAI-1.2-Opal"
description: "Modèle équilibré de 33B paramètres, offrant le parfait équilibre entre intelligence de niveau entreprise et fluidité."
...
- **Vision** : Prise en charge native de la vision multimodale (analyse précise de rapports financiers, infographies et documents multi-pages).
- **Date de sortie officielle** : 22/07/2026.
- **Empreinte mémoire recommandée** : ~24 Go à 32 Go de RAM.
...
- **RAG avancé à grande échelle** : Traitement de plusieurs documents volumineux dans la fenêtre de contexte de 256K.
- **Prise de décision automatisée** : Évaluation d'intentions complexes et appels d'outils (Tool Calling).
