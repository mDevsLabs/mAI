...
- **Multi-Modèles & Routage Intelligent** : Compatibilité transparente avec les modèles locaux mAI-1.5 (Light, Apex, Opal) et les modèles de raisonnement avancés dans le cloud.
- **Terminal Intégré & Feedback en Temps Réel** : Exécution de commandes de build, détection de linter et correction immédiate des erreurs d'exécution.
- **Refactoring & Diffs Multi-Fichiers** : Prévisualisation claire des modifications avec diffs visuels interactifs et application sélective.
