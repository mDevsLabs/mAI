...
In addition to the `FEATURE_FLAGS` system above, mAI provides dedicated environment variables to enable or disable specific features that depend on external infrastructure. These are standalone variables (not part of `FEATURE_FLAGS`):
