---
title: >-
  mAI Launches Knowledge Base: Intelligent File Management and Dialogue
  Experience
description: >-
  mAI introduces a brand new knowledge base feature that supports all file
...
The mAI knowledge base is now live in both the open-source edition and the Cloud edition (mAI.com). This release brings file management, intelligent processing, and file-based dialogue into one workflow, so teams can organize knowledge and retrieve information with less friction.
...
You can upload and store documents, images, audio, and video. mAI provides built-in online preview for common formats including PDF, Excel, Word, PPT, and TXT. The preview component is built on open-source foundations, with an architecture designed to expand to more file formats over time.
...
All features are open-sourced on the [GitHub repository](https://github.com/lobehub/lobe-chat). Visit [mAI Cloud](http://mAI.com) to experience the full functionality.
