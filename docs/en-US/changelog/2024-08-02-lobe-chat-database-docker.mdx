---
title: mAI Database Docker Image Official Release
description: >-
  mAI v1.8.0 ships the official database Docker image, completing the
...
# mAI Database Docker Image: The Final Piece of the Cloud Deployment Puzzle

With mAI v1.8.0, the official database Docker image is now available. This completes the server-side deployment path we have been building, so teams can run a full cloud deployment without gaps in their setup flow.
...
Visit the [official documentation](https://lobehub.com/en/docs/self-hosting/server-database) to start deploying your own mAI service.
