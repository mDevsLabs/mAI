...
description: >-
  mAI now supports DeepSeek R1 with real-time reasoning display, making
...
mAI v1.49.12 now supports DeepSeek R1 across both Community and Cloud editions. This integration brings the model's reasoning process into full view, so you can follow how complex questions are solved step by step.
...
1. Upgrade to mAI v1.49.12 or visit [mAI.com](https://mAI.com)
