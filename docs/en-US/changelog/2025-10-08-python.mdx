...
From September through October, mAI added a built-in Python execution environment, integrated Claude Sonnet 4.5, and improved how you navigate and edit content in long conversations.
...
Claude Sonnet 4.5 brings Anthropic's latest reasoning capabilities to mAI. The release also adds Vercel AI Gateway as a provider, alongside Seedream 4.0, CometAPI, and NewAPI. Gemini 2.5 video understanding capabilities are updated.
