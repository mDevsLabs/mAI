---
title: mAI Adds a Persistent Agent Sidebar
description: >-
  mAI v1.26.0 introduces a persistent Agent sidebar with shortcut-based
...
In v1.26.0, mAI adds a persistent Agent sidebar to make high-frequency Agents easier to reach during active conversations. Instead of jumping between lists, you can keep your key Agents visible and switch with less friction.
