---
title: mAI Enters the Era of Artifacts
description: >-
  mAI v1.19 brings significant updates, including full feature support for
...
# mAI v1.19: Artifacts, Discovery, and More Models

mAI v1.19 is now live. This release brings a major step forward for day-to-day assistant usage, with stronger creation workflows, broader model access, and a redesigned way to discover what you can do next.

## Create with Artifacts

mAI now replicates the core Claude Artifacts experience. You can generate and interact with rich content directly in the conversation:
...
Thanks to community contributor [@CloudPassenger](https://github.com/CloudPassenger), mAI now supports GitHub Models as a provider. To start using it:
