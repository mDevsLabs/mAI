...
Authentication now extends to Amazon Cognito, Google SSO, and Okta. If your organization already runs on these systems, connecting mAI is now a configuration step rather than a migration project.
