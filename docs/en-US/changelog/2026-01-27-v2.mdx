---
title: "mAI v2.0 — Group Chat & Multi-Agent Collaboration \U0001F389"
description: >-
  mAI v2.0 brings major upgrades including multi-agent group chat, enhanced
...
mAI v2.0 marks a practical shift from single-agent chat to real multi-agent collaboration. It also improves model configuration, introduces SSO-only mode, and brings desktop polish so day-to-day work feels steadier.
