---
title: mAI Database Docker 镜像正式发布
description: mAI v1.8.0 推出官方数据库 Docker 镜像，补齐服务端部署链路，支持云端数据同步、用户管理，并提供完整的自部署文档。
tags:
  - mAI
  - Docker 镜像
  - 云端部署
...
# mAI Database Docker 镜像：云端部署的最后一块拼图

mAI v1.8.0 正式发布官方数据库 Docker 镜像。这补齐了我们持续完善的服务端部署链路，让团队可以更顺畅地完成完整的云端部署流程。
...
访问[官方文档](https://lobehub.com/zh/docs/self-hosting/server-database)开始部署你自己的 mAI 服务。
