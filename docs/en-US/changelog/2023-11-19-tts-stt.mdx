...
description: >-
  mAI now supports Text-to-Speech (TTS) and Speech-to-Text (STT), enabling
...
mAI now supports Text-to-Speech (TTS) and Speech-to-Text (STT), turning typed conversations into natural voice interactions. You can speak with your Agents and hear their responses, making the experience closer to talking with a real person.
...
Voice support closes the gap between human and AI interaction styles. Speak naturally, hear responses aloud, and maintain context just like you would in a spoken conversation. The rest of mAI's features—plugins, multimodal support, context management—work seamlessly alongside voice mode.
