...
九月到十月，mAI 新增了内置 Python 执行环境，接入了 Claude Sonnet 4.5，并优化了长会话中的导航与内容编辑体验。
...
Claude Sonnet 4.5 将 Anthropic 最新的推理能力引入 mAI。本次还新增 Vercel AI Gateway 作为服务商，以及 Seedream 4.0、CometAPI、NewAPI 等。Gemini 2.5 视频理解能力同步更新。
