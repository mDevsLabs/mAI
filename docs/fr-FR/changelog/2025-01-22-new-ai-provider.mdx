...
The provider management system has been rebuilt from the ground up. Now you can add your own AI providers, edit existing ones, and configure custom models with specific capability settings. Available in both the open-source edition and [mAI Cloud](https://mAI.com).
