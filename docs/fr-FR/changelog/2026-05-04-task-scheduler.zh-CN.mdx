---
title: 在 mAI 中调度 Claude Code 与 Codex
description: >-
  在 mAI 中直接调度 Claude Code 与 Codex，全新首页、批量 git diff 的 Review
  标签页、视觉理解工具，以及一批新模型。
tags:
  - 编程 Agent
  - Claude Code
...
# 在 mAI 中调度 Claude Code 与 Codex

现在你可以在 mAI 内使用 Coding Agents。新建助手时选择你最喜欢的 Coding Agent 即可。此功能仅在桌面端可用。

![](/blog/assets71fe5959cbc6f0a89243d7262f48fafc.webp)

## 新功能

- 新增：在 mAI 中调度 Claude Code 与 Codex
