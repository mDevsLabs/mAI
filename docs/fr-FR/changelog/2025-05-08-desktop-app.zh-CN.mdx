...
description: mAI 推出基于 Lobe UI v2 的全新视觉设计，并正式发布 Windows 与 macOS 桌面端应用。
tags:
  - 桌面端
  - mAI
  - Lobe UI v2
...
四月带来了两项看得见、摸得着的重大变化：基于全新 Lobe UI v2 设计系统的完整视觉刷新，以及 mAI 桌面端的正式发布。两者结合，让日常使用更现代、更流畅，也更贴合桌面场景。
...
mAI 现已作为原生桌面应用支持 Windows 和 macOS。它包含系统托盘集成、原生窗口控制，以及与操作系统协调的键盘快捷键。

桌面端在以下场景尤为实用：

- 希望无需保持浏览器标签页打开就能使用 mAI
