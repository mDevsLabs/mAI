...
Want to see how you have been using mAI? The new statistics page gives you a clear view of your activity patterns, from agent usage to message volume. You can also generate a shareable activity card to post or send to friends.
