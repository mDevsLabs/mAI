...
description: >-
  mAI launches a refreshed visual design with Lobe UI v2 and officially
...
April brings two major changes you can see and touch: a complete visual refresh powered by the new Lobe UI v2 design system, and the official release of the mAI desktop app. Together they make daily usage feel more modern, more fluid, and better suited to desktop workflows.
...
mAI is now available as a native desktop application for Windows and macOS. It includes system tray integration, native window controls, and keyboard shortcuts that feel at home on your operating system.

The desktop app matters most when you:

- Want mAI available without keeping a browser tab open
