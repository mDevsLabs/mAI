...
description: >-
  mAI expands its AI ecosystem with 50+ new models and 10+ providers, making
...
mAI completed its largest AI ecosystem expansion this February. The goal is straightforward: give you access to more capable models across more providers without breaking your existing workflow or requiring new setup steps.

## Expanded provider and reasoning coverage

This release adds 10+ mainstream providers spanning global and domestic platforms. You can now connect to a wider range of services directly from your existing mAI setup.
