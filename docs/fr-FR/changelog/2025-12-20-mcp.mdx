...
In November, mAI continued improving model support and day-to-day usability. This update expands the MCP tool ecosystem with managed cloud endpoints, broadens provider coverage, and improves how teams organize knowledge and authenticate across platforms.
