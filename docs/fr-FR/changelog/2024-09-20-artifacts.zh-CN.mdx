---
title: 重磅更新：mAI 迎来 Artifacts 时代
description: >-
  mAI v1.19 带来了重大更新，包括 Claude Artifacts 完整特性支持、全新的发现页面设计，以及 GitHub Models
...
# mAI v1.19：Artifacts、发现页与更多模型

mAI v1.19 正式发布。这次更新围绕日常使用体验带来了一次关键升级：创作流程更完整、模型选择更丰富、能力发现路径也更清晰。

## 用 Artifacts 创作

mAI 现已还原 Claude Artifacts 的核心体验。你可以在对话中直接生成并交互丰富的内容：
...
感谢社区成员 [@CloudPassenger](https://github.com/CloudPassenger) 的贡献，mAI 现已支持 GitHub Models 作为服务商。使用流程如下：
