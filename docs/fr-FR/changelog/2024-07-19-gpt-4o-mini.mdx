---
title: 'mAI v1.6: GPT-4o Mini Joins the Default Lineup'
description: >-
  mAI v1.6 adds GPT-4o mini support, while mAI Cloud upgrades its
...
# mAI v1.6: GPT-4o Mini Joins the Default Lineup

OpenAI's full model family has moved to GPT-4. mAI v1.6 follows that shift, adding GPT-4o mini to the supported models. For mAI Cloud users, this upgrade goes further: GPT-4o mini is now the default, replacing GPT-3.5-turbo.
...
For mAI Cloud users, the service upgrade is automatic. New conversations start with GPT-4o mini by default. Existing users don't need to change any settings—the model switcher simply shows the new default first.
...
- Updated mAI Cloud default model selection logic
