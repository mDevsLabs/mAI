...
From August through September, mAI expanded Gemini-related capabilities across image generation, response behavior, and model coverage. The goal was straightforward: make newer Gemini workflows easier to run in production while keeping your provider options open.
