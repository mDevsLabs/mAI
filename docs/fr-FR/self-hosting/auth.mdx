...
| `NEXT_PUBLIC_AUTH_URL` | Required | The browser-accessible base URL for Better Auth (e.g., `http://localhost:3010`, `https://mAI.com`). Optional for Vercel deployments (auto-detected from `VERCEL_URL`) |
