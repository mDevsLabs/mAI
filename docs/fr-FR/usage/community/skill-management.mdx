...
| ------------------------ | ------------------------------------ | ----------------------------------------- |
<<<<<<< HEAD:docs/fr-FR/usage/community/skill-management.mdx
...
>>>>>>> 1fa6f47fc9f31fb26afca2b61a9c57751eaff2e0:docs/usage/community/skill-management.mdx
...
<<<<<<< HEAD:docs/fr-FR/usage/community/skill-management.mdx
- **mAI** — Built-in tools and mAI-native integrations (Linear, Microsoft, Twitter, Klavis services)
=======
...
<<<<<<< HEAD:docs/fr-FR/usage/community/skill-management.mdx
Built-in tools (Artifacts, Sandbox, GTD, Notebook) are pre-installed — you can enable them for any Agent immediately. mAI Integrations and Klavis services require an OAuth connection:
=======
...
<<<<<<< HEAD:docs/fr-FR/usage/community/skill-management.mdx
**Integrations** — Built-in tools, mAI-connected services, and Klavis integrations. Each shows its connection status. Click **Connect** or **Disconnect** to manage the OAuth link.
=======
