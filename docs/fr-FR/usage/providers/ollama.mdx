...
Ollama is a powerful framework for running large language models (LLMs) locally. It supports a variety of models, including Llama 2, Mistral, and more. mAI now integrates seamlessly with Ollama, allowing you to leverage these models directly within your chat interface.
...
mAI comes pre-configured with popular LLMs like llama3, Gemma, and Mistral. When you select a model for the first time, mAI will prompt you to download it.
